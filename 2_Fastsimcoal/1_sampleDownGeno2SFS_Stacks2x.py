...
###edited March 2020 to read vcf output from Stacks 2 or above
###command example: python sampleDownGeno2SFS_NoChrom_Anna.py <popmap> 4,5 <output_filename> <vcf-file> 5
###line 88 was modified for stacks version >1.45
	...
	for x in xrange(9,len(infoList)):
		if x-9 in selsp:
			if snpIndList[x] == "./.":
				...
				genotype,dp,ad,gq,gl = snpIndList[x].split(":") ### JBB MODIFY THIS LINE TO MATCH VCF FORMAT
			#print genotype
